            ...
            <div class="col-md-10">
                <div class="row">
                    <div class="col-md-9 offset-md-3 mx-auto">
                        ...
                        <form class="text-center" action="comp_flight_info.php" method="post">
                            <br>
                                <label for="flight_name">便名</label>
                                <input class="form-control" id="flight_name" type="text" name="flight_name" placeholder="NH◯◯◯">
                            <br>
                                <label for="content">内容</label>
                                <textarea class="form-control" id="content" name="content" placeholder="強風のため欠航　ETA:◯◯時◯◯分"></textarea>
                            <br>
                                <label for="share_name">発信者</label>
                                <input class="form-control" id="share_name" type="text" name="share_staff" placeholder="シフト責任者　◯◯">
                            <br>
