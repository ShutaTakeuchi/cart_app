...
$result = SqlLogic::delete_content('standby_record', $_GET['id']);
?>
...
<body class="top-page">
    <div class="container-fluid text-center">
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <?php if($result): ?>
                    <h2 style="margin-top: 30px;">登録内容を削除しました。</h2>
                <?php else: ?>
                    <h2>登録内容を削除できませんでした。</h2>
                <?php endif; ?>
                <br>
                <a class="btn btn-secondary" href="standby_record.php">一覧へ戻る</a>
            </div>
        </div>
    </div>
</body>
