...
SqlLogic::delete_info('other_info');

// データを全件取得
$all_data = SqlLogic::get_table('other_info');

// 件数を取得
$count_record = SqlLogic::count_data('other_info');
?>
...
<body class="top-page">
    <div class="container-fluid text-center">
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <div class="row">
                    <h2 class="mx-auto" style="margin-top: 15px;">その他情報一覧</h2>
                </div>
                <a class="create_button btn btn-primary btn-block" href="create_other_info.php">新　規　作　成</a>
                <br>
                <div class='row'>
                <?php while($each_data = $all_data->fetch()): ?>
                    <div class="col-md-6">
                        <table class="table table-info table-sm table-bordered">
                            ...
                            <tr>
                                <th></th>            
                                <td><a href="delete_other_info.php?id=<?php echo $each_data['id']; ?>">削除</a></td>
                            </tr>
                        </table>
                    </div>
                <?php endwhile; ?>
                ...
                <?php if($count_record === 0): ?>
                    <h6 class=nothing>現在、その他の情報はありません。</h6>
                <?php endif; ?>
            </div>
        </div>
    </div>
