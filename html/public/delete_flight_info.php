...
$result = SqlLogic::delete_content('flight_info', $_GET['id']);
?>
...
<body class="top-page">
    <div class="container-fluid text-center">
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <?php if($result): ?>
                    <h2 style="margin-top: 30px;">フライト情報を削除しました。</h2>
                <?php else: ?>
                    <h2>フライト情報を削除できませんでした。</h2>
                <?php endif; ?>
                <br>
                <a class="btn btn-secondary" href="flight_info.php">フライト情報一覧へ戻る</a>
            </div>
        </div>
    </div>
</body>
